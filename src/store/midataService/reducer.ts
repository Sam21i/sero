...
import { UserAuthenticationData, UPDATE_USER_AUTHENTICATION, LOGOUT_AUTHENTICATE_USER, ADD_RESOURCE, ADD_RESOURCE_TO_SYNCHRONIZE, RESOURCE_SENT } from '../definitions';
